    ...
    <div className='flex flex-col items-center gap-6'>
      <div className='flex flex-col gap-3 text-center'>
        ...
        <p className='text-light-secondary dark:text-dark-secondary'>
          These settings affect all the Villa accounts on this browser.
        </p>
      </div>
      <article
      ...
      >
        <div className='grid grid-cols-[auto,1fr] gap-3'>
          <UserAvatar src='/assets/twitter-avatar.jpg' alt='Villa' />
          <div>
            <div className='flex gap-1'>
              <UserName verified name='Villa' />
              <p className='text-light-secondary dark:text-dark-secondary'>
                @villa
              </p>
            ...
            <p className='whitespace-pre-line break-words'>
              At the heart of Villa are posts — just like this one — which can
              include photos, videos, links, text, hashtags, and mentions like{' '}
              <span className='text-main-accent'>@villa</span>.
            </p>
          </div>
        </div>
      </article>
